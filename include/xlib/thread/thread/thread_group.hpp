...
#ifndef XLIB_THREAD_THREAD_THREADGROUP_HPP_
#define XLIB_THREAD_THREAD_THREADGROUP_HPP_

#include <utility>

#include "xlib/thread/thread/thread.hpp"
...
class thread_group {
 public:
  ...
  thread_group(std::string name) : name_(std::move(name)), first_(nullptr) {}

  template <typename Function>
  thread_group(std::string name, Function f, std::size_t num_threads) : name_(std::move(name)), first_(nullptr) {
...
#endif  // XLIB_THREAD_THREAD_THREADGROUP_HPP_
